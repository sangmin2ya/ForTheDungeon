...
public class ItemController : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Start()
    {
        ...
        switch (_itemType)
        {
            case ItemType.Potion:
                ...
                break;
            case ItemType.Herb:
                tooltipText.text = "영구적으로 특정 능력치를 5증가시키는 허브.\n던전이 주요 자생지이다.";
                break;
            case ItemType.Candy:
    ...
    public void IncreaseStrength()
    {
        ...
        _player.IncreaseStat(StatType.Strength, 5);
    }
    public void IncreaseVitality()
    {
        choicePanel.SetActive(false);
        _player.IncreaseStat(StatType.Vitality, 5);
    }
    public void IncreaseIntelligence()
    {
        choicePanel.SetActive(false);
        _player.IncreaseStat(StatType.Intelligence, 5);
    }
    public void IncreaseVision()
    {
        choicePanel.SetActive(false);
        _player.IncreaseStat(StatType.Vision, 5);
    }
    public void IncreaseSpeed()
    {
        choicePanel.SetActive(false);
        _player.IncreaseStat(StatType.Speed, 5);
    }
}